...
winget install  --accept-source-agreements --accept-package-agreements --scope user --source winget --silent --exact ${programs}

. "${env:LOCALAPPDATA}\Programs\oh-my-posh\bin\oh-my-posh.exe" font install hack
