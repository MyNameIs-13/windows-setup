...
; defines keyboard shortcuts to control virtual desktops
...
^#up::VD.goToRelativeDesktopNum(-1)
^#down::VD.goToRelativeDesktopNum(+1)

; move window to left and follow it
^#+up::VD.goToDesktopNum(VD.MoveWindowToRelativeDesktopNum("A", -1))
